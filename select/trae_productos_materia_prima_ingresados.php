<?php	 
   ...
   try{	
		...
		$sql2="select
				...
				WHERE calidad.numero_orden_compra =".$numero_orden." and  calidad.aceptada <> 'si'  and  calidad.rechazada <> 'si' ";
		...
		{	 					
				...
				/*echo	"<td id='td_aceptar_producto".$mensaje2[0]."'><input type='checkbox' id='cambiar_cant".$mensaje2[0]."' onClick='$(this).aceptar_cantidad_recepcionada_materia_prima(".$mensaje2[0].",".$numero_orden.");'>Aceptar</td>";*/
				echo	"<td><a href='#' id='cambiar_cant".$mensaje2[0]."' onClick='$(this).aceptar_cantidad_recepcionada_materia_prima(".$mensaje2[0].",".$numero_orden.");' title='Ingresar Informacion' class='icon-editar info-tooltip'></td>";
