		...
		<td height="100%">
			<div class="body">
				<div class="modulo widht_modulo_full">
					<div class="title"><p>Listado de Proveedores</p>
					</div>
					<div class="content">     
						<section>
											...
											<tr>
												<?php
													...
													switch ($opcion) {
														...
														?>
															<div class="fright">
                                                                                                                            <a href="crear_proveedor_nacional.php"><input type="button" value="Crear Proveedor Nacional&raquo;" /></a>
														...
														<?php
															...
															$negocio=new negocio();
															echo $negocio->muestra_prov_nac();
															break;
														case 2:
														?>
															<div class="fright">
                                                                                                                            <a href="crear_proveedor_internacional.php"><input type="button" value="Crear Proveedor Internacional&raquo;" /></a>
															</div>														
														<?php
															include_once("clases/negocio.php");
															$negocio=new negocio();
															echo $negocio->muestra_prov_int();
															break;
													}										
												?>
											</tr>
