					...
					<div>  
						...
						<table class="tableform"> 
							...
							<tr>
								...
								<td>
									<input type="text" id='nom_client' placeholder="Ingrese Razón Social/Nombre" />
								...
								<td>
									<select id="list_canal"> 
									</select> 
									<div id="valida-list_canal" style="display:none" class="errores">
										Debe Seleccionar Canal 
									</div>
								</td>
							</tr>
                                                        <tr>
							...
							<tr>
								...
								<td>
									<input type="text" id='credito' value="0" disabled placeholder="Ingrese Credito"/>
								...
								<td>
									<select id="list_vendedores"> 
									</select> 
									<div id="valida-list_vendedores" style="display:none" class="errores">
							...
							<tr>
								<td colspan="4">
									<div class="fright"><input  onClick='$(this).crear_cliente_nacional();' type="submit" value="Crear&raquo;"/>
									</div>
								</td>
							</tr>
						</table>
