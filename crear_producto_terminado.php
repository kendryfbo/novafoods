	...
	<td height="100%">
		<div class="body">	
			...
			<div class="modulo widht_modulo_full">
				<div class="title"><p>Creacion de Producto Terminado</p>
				</div>
				<div class="content">          
					<div>  
						...
						<table class="tableform"> 
					 		<tr>
								...
								<td>
									<select id="list_tipo_producto" >
									</select>
									<div id="valida-list_tipo_producto" style="display:none" class="errores">
										Debe Seleccionar Tipo de Producto
									</div> 
								</td>       
							</tr>
                                                        <tr>
							...
							<tr>
							 ...
							 <tr>
								...
								<td>
									<input type="text" id='peso_neto' placeholder="Ingrese Peso Neto" onkeypress="ValidaSoloNumeros()"readonly/>
							 ...
							 <tr>
    							<td>
									<label>Cajas por Batch</label>
								</td>
								<td>
									<input type="text" id='cajas_bat' placeholder="Ingrese Cajas Por Batch" onkeypress="ValidaSoloNumeros()"/>
									<div id="valida-cajas" style="display:none" class="errores">
										Debe Ingresar Cajas Por Batch
									</div> 
								</td>
							</tr>
							<tr>
								<td colspan="4">
									<div class="fright"><input onClick='$(this).ingresa_producto_term();' type="submit" value="Crear&raquo;"/>
									</div>
								</td>
							</tr>
						</table>
