<?php	 
	...
	if ($funcion==1)
	{
		...
		try{
				$numero_nota_venta=trim($_POST["numero"]);
				...
				where nota_venta.numero=".$numero_crl;
                        ...
                        echo"   <div class='modulo widht_modulo_full'>
                                    <div class='title'><p>Nota de Venta</p>
                                    </div>
                                    <div class='content'>  
                                        <br>         
					<div>  
                                            <div class='fright'>
                                                <a href='crear_nota_venta.php'><input type='button' value='Volver&raquo;'/></a>
                                            </div>
					</div>
	...
	else if ($funcion==2)
	{
		try{
				...
				where nota_venta.numero=".$numero_crl;
                        ...
                        echo"   <div class='modulo widht_modulo_full'>
                                    <div class='title'><p>Autorizacion de Nota de Venta Por Comercial</p>
                                    </div>
                                    <div class='content'>  
                                        <br>         
					<div>  
                                            <div class='fright'>
                                                <a href='listado_nota_venta_por_autorizar.php'><input type='button' value='Volver&raquo;'/></a>
                                            </div>
					</div>
					<table class='tableform'>
                                            <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                         <table class='tablesorter'> 
                                                                                             ...
                                                                                             <tr>
                                                                                                 <td>
                                                                                                         <input type='radio' name='desicion' id='desicion1' value='1'onClick='$(this).autoriza_nv_gte1();'> Autorizar<br>

                                                                                                 </td>
                                                                                                 <td>

                                                                                                         <input type='radio' name='desicion' id='desicion1' value='0' onClick='$(this).autoriza_nv_gte1();'> Rechazar<br>
                                                                                                 </td>
                                                                                             </tr>
                                                                                         </table>
                                                                                         <table class='tablesorter'> 
