...
<head>
	...
	<script src="js/funcion_ventas_productos2.js"></script>
		...
		<td height="100%">
			<div class="body">
				<div class="modulo widht_modulo_full">
					<div class="title"><p>Informe Ventas Nacionales</p>
					</div>
					<div class="content">     
						<section>
											...
											<tr>
												<th>
													Seleccione datos a Filtrar :
                                                                                        ...
                                                                                        <tr>
												<td>
                                                                                                    <input type="checkbox" name="ranfec" value="1" onClick='$(this).rango_fecha2();'checked> Rango de Fecha
                                                                                                    <input type="checkbox" name="ranpro" value="1" onClick='$(this).rango_producto2();'> Producto
                                                                                                    <input type="checkbox" name="rancli" value="1" onClick='$(this).rango_cliente2();'> Cliente
                                                                                                        <!--
