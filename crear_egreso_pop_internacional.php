		...
		<td height="100%">
			<div class="body">
				<div class="modulo widht_modulo_full">
					<div class="title"><p>Solicitud de Material POP Internacional</p></div>
						<div class="content">          
							<div>  
								...
								<table class="tableform">
									<tr>									
										...
										<td>
											<input type="text" id="num_egreso" readonly/>									
										</td>
										<td>
											<label>Fecha</label>
										</td>
									...
									<tr>
										...
										<td>
											<input type="text" id="num_proforma"  placeholder="Numero de Proforma"/>	
											<div id="valida-num_prof_vac" style="display:none" class="errores">
												Debe Ingresar Numero de Proforma
											</div> 
											<div id="valida-num_prof" style="display:none" class="errores">
												Debe Ingresar Numero de Proforma Correcto
											</div> 
										</td>
										<td>
											<label>Cliente</label>
								...
								<table class="tableform"  id="prod2">  <!--style = " display : none "-->
									...
									<tr>
										<td colspan="3" id='stock' class="errores">  
										</td>	
									</tr>
										<td colspan="4">
											<div class="fright">
												<input type="submit" onClick='$(this).agregar_productos_salida();' value="Solicitar Productos &raquo;"/>
											</div>
								...
								<div> 
									<div class="fright">
										<input onClick='$(this).crear_solicitud_egreso_internacional();'id='envio_salida' type="submit" value="Enviar Solicitud &raquo;"/>
									</div> 
								</div> 
							</div> 		
						</div>
