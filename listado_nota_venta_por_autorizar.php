...
<html lang="es"> 
<head>
	<title>Notas de Venta por Autorizar</title>
	<meta charset="utf-8" />
		...
		<td height="100%">
			<div class="body" id="cabeza_nota_venta">
				<div class="modulo widht_modulo_full">
					<div class="title"><p>Listado de Notas de Venta por Autorizar por Comercial</p>
					</div>
					<div class="content">     
						<section>
										...
										<tbody>
											<tr>
												<?php
													...
													$negocio=new negocio();
													echo $negocio->muestra_nv_por_autorizar1();
												?>
											</tr>
										<tbody>
									 </table>
