	...
	if ($funcion==1)
	{
		...
		try{	
			...
			//$mensaje2=mysql_fetch_array($resultado2);
					...
					if ($mensaje2[8]<>'Si')
					{
						echo	"<td  style='text-align:center'><a href='#' title='Borrar Informacion' onClick='$(this).elimina_prod_detalle_nota_venta(".$mensaje2[0].",".$id_usuario.");'class='icon-borrar info-tooltip'></a></td>";						
