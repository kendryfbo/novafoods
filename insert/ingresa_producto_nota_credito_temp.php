<?php	 
	...
	$id_Usuario=trim($_POST["id_Usuario"]);	
        ...
        $des_referencia=trim($_POST["des_referencia"]);
		...
		try{	
				...
				else
				{
					$valor=$numero_nota_venta;
                                ...
                                if($des_referencia<>""){
                                    $sql3="INSERT INTO temporal_detalle_nc (Cantidad,id_producto,Precio,total,porcentaje,descuento,id_usuario,ila,factura,nv,id_cv,referencia,observacion,obs_gen)
					VALUES ('1','0','$monto','$monto','0','0','$id_Usuario','','$factura','$numero_nota_venta','$centro_venta','$referencia','$observacion_nc','$des_referencia')";
                                }else{
                                    $sql3="INSERT INTO temporal_detalle_nc (Cantidad,id_producto,Precio,total,porcentaje,descuento,id_usuario,ila,factura,nv,id_cv,referencia,observacion)
					VALUES ('$cajas','$id_producto','$precio','$total_2','$descuento','$total_descuento','$id_Usuario','$ila','$factura','$numero_nota_venta','$centro_venta','$referencia','$observacion_nc')";
                                }
