<?php	 
   ...
   try{	
		...
		{	 					
				...
				echo	"<tr><td></td><td></td><td id='valida-cantidad_prod".$mensaje2[0]."' style='display:none' class='errores'>Debe Ingresar Numeros</td><tr>"; 
				echo	"<tr><td></td><td></td><td id='valida-cantidad_input".$mensaje2[0]."' style='display:none' class='errores'>Debe Ingresar Un Numero Menor al Que Ingresa</td>"; 
				echo	"</tr>";
				echo	"</tbody>";
		}
