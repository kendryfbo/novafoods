		...
		<td height="100%">
			<div class="body">				 
				<div class="modulo widht_modulo_full">
					<div class="title"><p>Creacion de Giros</p>
					</div>
					<div class="content">     
						<section>
									...
									<tr>
										...
										<td>
											...
											<div id="valida-giro" style="display:none" class="errores">
												Debe Ingresar el Giro
											</div> 
											<div id="valida-giro_r" style="display:none" class="errores">
												Su Giro Se Encuentra Registrado
											</div> 
										</td>
										<td colspan="2">
											<div class="fright"><input type="submit" value="Crear &raquo;"	onClick='$(this).ingresa_giro();'/>
											</div>
										</td>
									</tr>
								</table>
