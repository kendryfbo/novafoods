		...
		<td height="100%">
			<div class="body">
				<div class="modulo widht_modulo_full">
					<div class="title"><p>Listado de Material POP</p>
					</div>
					<div class="content">     
						<section>
							<article class="module width_full"> 
								<div>  
									<div class="fright">
										<a href="crear_producto_pop.php"><input type="button" value="Crear Nuevo&raquo;" /></a>
									</div>
								</div>
								<br>
										...
										<tbody>
											<tr>
												<?php
													...
													$negocio=new negocio();
													echo $negocio->muestra_productos_pop();
												?>
											</tr>
										<tbody>
									 </table>
