			...
			<div class="body">
				<div class="modulo widht_modulo_full">
					...
					<div class="content">  
						<br>         
							<div class="fright">
								<a href="aprobar_material_pop.php" ><input type="button" value="Volver&raquo;"/></a>
							</div>
						</div>
					 	<table class="tableform">
							...
							<tr>
								<td colspan="5">
									<div class="fright"> 
										<input type="submit" onClick='$(this).aprobar_ingreso_productos_orden_compra_mat_pop();' value="Ingreso Cantidades&raquo;" /> 
									</div>
								</td>
							</tr>
						</table>
