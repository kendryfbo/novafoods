...
$(document).ready(function() {
    $( "#list_familia_mprima").change(function() {
        //alert("hola");
	...
	<td height="100%">
		<div class="body">		 
			<div class="modulo widht_modulo_full">
				<div class="title"><p>Creacion de Materia Prima</p>
				</div>
				<div class="content">          
					<div>  
                                            <div class="fright"><a href="listado_producto_terminado_mp.php" ><input type="button" value="Volver &raquo;"/></a>
							</div>
						</div>
						<table class="tableform"> 
								...
								<td>
									<select id="list_familia_mprima" onchange='$(this).select_familia();'>
									</select>
									<div id="valida-list_familia_mprima" style="display:none" class="errores">
							...
							<tr>
								<td colspan="4">
									<div class="fright"><input onClick='$(this).ingresa_producto_mat_prima();' type="submit" value="Crear&raquo;"/>
									</div>
								</td>
							</tr>
						</table>
