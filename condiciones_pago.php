		...
		<td height="100%">
			<div class="body">
				<div class="modulo widht_modulo_full">
					<div class="title"><p>Listado de Condiciones de Pago</p>
					</div>
					<div class="content">     
						<section>
							<article class="module width_full"> 
								<div>  
									<div class="fright">
										<a href="crear_condicion_pago.php"><input type="button" value="Crear Nuevo&raquo;"/></a>
									</div>
								</div>
								<br>
										...
										<tbody>
											<tr>
												<?php
													...
													$negocio=new negocio();
													echo $negocio->muestra_cond_pago();
												?>
											</tr>
										<tbody>
									 </table>
